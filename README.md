...
1. **Buat Database & Tabel** _(MUHAMMAD NUR ALAM)_
   - Buka tab **SQL** di phpMyAdmin
   - Salin isi `sql/database.sql` → klik **Go**

2. **Masukkan Data Awal** _(MUHAMMAD NUR ALAM)_
   - Salin isi `sql/data_awal.sql` → klik **Go**

3. **Buat Stored Procedure** _(M. AFRIZAL FAHREZY, ANDI DEWA FIRDAUS & MUH. ARDIANSYAH)_
   - Salin isi `sql/procedure_rekap_nilai.sql` → klik **Go**

4. **Jalankan Pengujian** _(M. AFRIZAL FAHREZY, ANDI DEWA FIRDAUS & MUH. ARDIANSYAH)_
...
_Program Studi S1 Informatika – Universitas Mega Buana Palopo – 2026_
...
> Output: _"Semua stored procedure berhasil dibuat."_
